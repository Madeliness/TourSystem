...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add" name="form-article-add" method="post" action="__URL__/do_uptour">
		<input type="hidden" value="<?php echo ($data["tid"]); ?>" name="tid" id="tid">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
				<span class="select-box">
					<select name="tourcolumn" class="select" value="<?php echo ($data["tcity"]); ?>">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($data["tlevel"]); ?>" placeholder="AAAA" id="tourlevel" name="tourlevel">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($data["taddress"]); ?>" placeholder="陕西省西安市芙蓉西路99号" id="tourad" name="tourad">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($data["ticket"]); ?>" placeholder="通票150元" id="ticket" name="ticket">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($data["tline"]); ?>" placeholder="40路" id="tourline" name="tourline">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>发布人：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" readonly="readonly" class="input-text" value="<?php echo ($data["aname"]); ?>" placeholder="zhang" id="author" name="author">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>发布日期：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" onfocus="WdatePicker({startDate:'%y',dateFmt:'yyyy-MM-dd',maxDate:'%y-%M-%d',minDate:'%y-%M-%d'})" id="commentdatemin" name="commentdatemin" class="input-text Wdate" value="<?php echo ($data["tctime"]); ?>">
			</div>
		</div>
		<div class="row cl">
